<template>
  <div id="previewitem">
        <b-card v-if="!recipe.isWatched"  
          ...
          <b-card-text  @click="Watch">
            <ul class="recipe-overview">
              ...
              <li v-if="recipe.isVeget" class="list-item-with-image">Veget
                <img src="../assets/veget-logo.png" alt="Image">
              </li>
              <li v-else class="list-item-with-image">Non Veget
        ...
        img-top
        tag="article"
        style="max-width: 20rem; color: rgb(66, 5, 66);"
        class="mb-2 enlarge-on-hover"
        border-variant="dark">
         <router-link
              :to="{ name: 'recipe', params: { recipeId: recipe.id ,src: recipe.source} }"
              class="recipe-preview" @click="Watch">
          <b-card-text>
            <ul class="recipe-overview">
